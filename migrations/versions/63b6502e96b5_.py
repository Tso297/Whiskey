...
Revision ID: 63b6502e96b5
Revises: 141c46bf8842
Create Date: 2024-02-13 20:07:07.337825
...
def upgrade():
    ...
    op.create_table('whiskey__collection',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('whiskey', sa.String(length=150), nullable=False),
    sa.Column('origin', sa.String(length=200), nullable=True),
    sa.Column('proof', sa.String(length=20), nullable=True),
...
def downgrade():
    ...
    op.drop_table('whiskey__collection')
    # ### end Alembic commands ###
